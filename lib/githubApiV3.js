...
( function(globals){
    ...
    collaboratorsBuilder = function( context, callback){
    ...
    collaboratorsBuilder.prototype.details = function( response ){
        ...
        for( var i = 0; i < this.nbCollaborators; i++){
    ...
    gh3.repo.prototype.collaborators = function( context, callback ){
        jsonp( this.baseUrl() + "/collaborators?page=1&per_page=100", context, callback);
        return this;
    };
